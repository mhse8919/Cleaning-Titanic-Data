...
addmagins(table(tatanic$pclass, tatanic$sex), 2)
aggregate(cbind(age, fare)~pclass+sex, tatanic, mean)
ddply(tatanic, .(pclass, sex, fsurvived), summarise, count = length(fsurvived)
